...
app.use(session({
    secret: '7ed049e344f73f399ba1f7868cf9494f4b13347ecce02a8e463feb32507b73a5',
    resave: false,
...
// Middleware to block access to /api directory
...
app.post('/add-annale', upload.array('files', 3), (req, res) => {
    ...
    files.forEach(file => {
        const oldPath = path.join(__dirname, '../../../cache', file.filename);
